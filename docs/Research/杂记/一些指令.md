...
```bash
ffmpeg -i /work/disk2/xierh/jwork/Data/GuangZhong_ori/Lap_Videos/lin_peng/4.mp4 -r 1 -q:v 2 /work/disk2/xierh/jwork/Data/GuangZhong_ori/Fames/lin_peng/frames/1-out%04d.jpg
```
