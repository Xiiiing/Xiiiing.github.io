...
initMap({mapName:'china',jsonPath:'/_javascripts/china.json',seriesName:'中国地图',data:highlightData.china});function showBoldAlert(province){const overlay=document.createElement('div');overlay.style.cssText=`
  ...
  `;overlay.appendChild(dialog);document.body.appendChild(overlay);document.getElementById('btn-ok').onclick=()=>{document.body.removeChild(overlay);};}